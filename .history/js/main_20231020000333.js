...
$(document).ready(function() {
      ...
      if ($(window).width() <= 768) {
          if (!$('.tab-content .tab-biobank').hasClass('slick-initialized')) {
              $('.tab-content .tab-biobank').slick({
                  ...
                  slidesToShow: 1,
                  slidesToScroll: 1
              }).on('afterChange', updateSlideNumber);
          }
      } else {
          if ($('.tab-content .tab-biobank').hasClass('slick-initialized')) {
  ...
  function updateSlideNumber(event, slick, currentSlide, nextSlide) {
  ...
  $('ul.tabs li').click(function() {
      ...
      if ($(this).hasClass('current')) {
          ...
          $tabContent.addClass('current').hide().fadeIn(500);
          $('.biobank_top').hide().fadeIn(500);

          $('.tab-content .tab-biobank').slick('slickGoTo', slideIndex, false);
      }
  });
