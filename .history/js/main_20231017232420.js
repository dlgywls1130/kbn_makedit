...
document.addEventListener('DOMContentLoaded', function() {
  ...
  counters.forEach(counter => {
      function updateCounter() {
          ...
          const speed = (target <= 1000) ? 25 : target / 500;
          const increment = (count < target/2) ? speed : (target - count) / 20;
      ...
      if (target <= 1000) {
          ...
          const startNumber = target / 2;
          counter.innerText = addCommas(startNumber.toFixed(0));
      }
