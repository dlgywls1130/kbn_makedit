  ...
  $(document).ready(function () {
    ...
    $(window).scroll(function () {
      ...
      scrollTimeout = setTimeout(function () {
        scrolling = false;
        // 스크롤이 멈췄을 때, 헤더를 부드럽게 숨김
        header.addClass('header_hidden_smooth');
      }, 500); // 0.5초 동안 스크롤이 없으면 부드럽게 숨김
    });

    // 네비게이션 링크 클릭 시 스크롤 애니메이션 적용
