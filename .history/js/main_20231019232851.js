...
$(document).ready(function() {
  ...
  $(window).scroll(function() {
      if ($(window).scrollTop() > $('.biobank_tab_wrapper').offset().top && $(window).scrollTop() < ($('.biobank_tab_wrapper').offset().top + $('.biobank_tab_wrapper').height() - $biobankTop.height())) {
          $biobankTop.fadeIn();
      } else {
          $biobankTop.fadeOut();
      }
